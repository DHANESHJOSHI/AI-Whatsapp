...
const BOT_NAME = process.env.BOT_NAME ?? "Dhanesh Joshi";
            ...
            if (budy) {
                try {
                    ...
                    let prompt_template =
                        ...
                        BOT_NAME +
                        " developed by a Dhanesh B Joshi.\n\nHuman: Hi. How are you?\n" +
                        BOT_NAME +
                ...
                switch (command) {
                    case 'ai':
                        try {
                            ...
                            if (!text) return reply(`Chat Fluid AI.\n\nContoh:\n${prefix}${command} Api key`)
                            const configuration = new Configuration({
                                apiKey: setting.keyopenai,
                            });
                            const openai = new OpenAIApi(configuration);
                            ...
                            console.log(err)
                            m.reply('Maafii, Kuch to Error aara hai!')
                        }
                        break
                    default: {
